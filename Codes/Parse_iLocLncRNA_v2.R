...
iLocLnc_files_list = list.files('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/EV/iLoc-LncRNA_V2//', full.names = T)
iLocLnc_files_names = gsub('.txt', '',list.files('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/EV/iLoc-LncRNA_V2//'))
...
write.csv(iLocLnc_preds_all, 
          file = 'Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/EV/iLoc-LncRNA_V2//test_EV_subsample_iLocLncRNA_all.csv',
          row.names = T, quote = T)
...
iLocLnc_files_list = list.files('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/IC/iLoc-LncRNA_V2//', full.names = T)
iLocLnc_files_names = gsub('.txt', '',list.files('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/IC/iLoc-LncRNA_V2//'))
...
write.csv(iLocLnc_preds_all, 
          file = 'Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/IC/iLoc-LncRNA_V2/test_IC_subsample_iLocLncRNA_all.csv',
          row.names = T, quote = T)
...
iLocLnc_preds_IC <- read.csv('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/IC/iLoc-LncRNA_V2//test_IC_subsample_iLocLncRNA_all.csv')
iLocLnc_preds_EV <- read.csv('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/EV/iLoc-LncRNA_V2/test_EV_subsample_iLocLncRNA_all.csv')
...
write.csv(iLocLnc_preds_total, 
          file = 'Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/iLocLnc_V2_predictions_total.csv',
          row.names = T, quote = F)
...
iLocLnc_preds_total <- read.csv('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/iLocLnc_V2_predictions_total.csv')
...
cm
draw_confusion_matrix(cm, Class1='IC', Class2='EV', title_val = 'iLocLncRNA V2')
