...
iLocLnc_files_list = list.files('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/EV/iLoc-LncRNA_V1/', full.names = T)
iLocLnc_files_names = gsub('.txt', '',list.files('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/EV/iLoc-LncRNA_V1/'))

iLocLnc_files = lapply(iLocLnc_files_list, readLines)
predictions_text = iLocLnc_files[[1]]
...
write.csv(iLocLnc_preds_all, 
          file = 'Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/EV/iLoc-LncRNA_V1/test_EV_subsample_iLocLncRNA_all_V1.csv',
          row.names = T, quote = T)
...
iLocLnc_files_list = list.files('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/IC/iLoc-LncRNA_V1//', full.names = T)
iLocLnc_files_names = gsub('.txt', '',list.files('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/IC/iLoc-LncRNA_V1//'))
...
write.csv(iLocLnc_preds_all, 
          file = 'Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/IC/iLoc-LncRNA_V1/test_IC_subsample_iLocLncRNA_all_V1.csv',
          row.names = T, quote = T)
...
iLocLnc_preds_IC <- read.csv('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/IC/iLoc-LncRNA_V1/test_IC_subsample_iLocLncRNA_all_V1.csv')
iLocLnc_preds_EV <- read.csv('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/EV/iLoc-LncRNA_V1/test_EV_subsample_iLocLncRNA_all_V1.csv')
...
table(iLocLnc_preds_EV$true_label, iLocLnc_preds_EV$pred_label)
...
table(iLocLnc_preds_total$pred_label, iLocLnc_preds_total$true_label)

write.csv(iLocLnc_preds_total, 
          file = 'Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/iLocLnc_V1_predictions_total.csv',
          row.names = T, quote = T)
...
iLocLnc_preds_total2 <- read.csv('Data/exoGRU_seqs/split_test_seqs/local_pred_outputs/iLocLnc_V1_predictions_total.csv')
...
cm
draw_confusion_matrix(cm, Class1='IC', Class2='EV', title_val = 'iLocLncRNA V1')
